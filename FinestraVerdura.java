...
public class FinestraVerdura extends JFrame {
	...
	private JTextField SelezionaVerdura_TF;
	 ...
	 * Create the frame.
	 */
	public FinestraVerdura(Controller c) {
		...
		JLabel Verdura_JLb = new JLabel("Verdura");
		Verdura_JLb.setHorizontalAlignment(SwingConstants.CENTER);
		Verdura_JLb.setFont(new Font("Cambria", Font.PLAIN, 20));
		Verdura_JLb.setBounds(187, 0, 109, 25);
		contentPane.add(Verdura_JLb);
		...
		Quantit‡_JLb.setBounds(10, 147, 261, 16);
		...
		Quantit‡_TF.setBounds(263, 144, 94, 23);
...
//					e1.printStackTrace();
		...
		JComboBox VerduraComboBox = new JComboBox();
		
		VerduraComboBox.setModel(new DefaultComboBoxModel(new String[] {"Cavolfiore", "Carote", "Spinaci", "Broccoli", "Lattuga", "Carciofi", "Pomodori", "Cipolle"}));
		VerduraComboBox.setToolTipText("");
		VerduraComboBox.setSelectedItem(null);
		VerduraComboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TipoVerdura = (String) VerduraComboBox.getSelectedItem();
				
				if(TipoVerdura.equals("Cavolfiore")) {
					PrezzoAlKilo_TF.setText("1.82");
					Quantit‡_TF.setEditable(true);
				}
				
				if(TipoVerdura.equals("Carote")) {
					PrezzoAlKilo_TF.setText("2.92");
					Quantit‡_TF.setEditable(true);
				}
				
				if(TipoVerdura.equals("Spinaci")) {
					PrezzoAlKilo_TF.setText("2.02");
					Quantit‡_TF.setEditable(true);
				}

				if(TipoVerdura.equals("Broccoli")) {
					PrezzoAlKilo_TF.setText("2.47");
					Quantit‡_TF.setEditable(true);
				}
				
				if(TipoVerdura.equals("Lattuga")) {
					PrezzoAlKilo_TF.setText("3.27");
					Quantit‡_TF.setEditable(true);
				}
				
				if(TipoVerdura.equals("Carciofi")) {
					PrezzoAlKilo_TF.setText("3.10");
					Quantit‡_TF.setEditable(true);
				}
				
				if(TipoVerdura.equals("Pomodori")) {
					PrezzoAlKilo_TF.setText("2.17");
					Quantit‡_TF.setEditable(true);
				}
				
				if(TipoVerdura.equals("Cipolle")) {
					PrezzoAlKilo_TF.setText("2.17");
					Quantit‡_TF.setEditable(true);
				}
		...
		VerduraComboBox.setBounds(10, 114, 109, 22);
		contentPane.add(VerduraComboBox);
		
		SelezionaVerdura_TF = new JTextField();
		SelezionaVerdura_TF.setEditable(false);
		SelezionaVerdura_TF.setFont(new Font("Cambria", Font.PLAIN, 14));
		SelezionaVerdura_TF.setText("Seleziona Verdura:");
		SelezionaVerdura_TF.setBounds(10, 78, 137, 25);
		contentPane.add(SelezionaVerdura_TF);
		SelezionaVerdura_TF.setColumns(10);
