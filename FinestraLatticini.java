...
public class FinestraLatticini extends JFrame {
	...
	public FinestraLatticini(Controller c) {
		...
		Quantit‡_JLb.setBounds(10, 147, 297, 16);
		...
		Quantit‡_TF.setBounds(292, 144, 82, 23);
		...
		PrezzoAlKilo_TF.setBounds(147, 174, 37, 20);
...
//					e1.printStackTrace();
		...
		SimboloEuro.setText("\u20AC");
		SimboloEuro.setBounds(187, 174, 18, 20);
		...
		LatticiniComboBox.setBounds(10, 114, 109, 22);
		...
		SelezionaLatticini_TF.setBounds(10, 78, 137, 25);
